 ...
 * describing the invocation, and returns a simulated weather payload. The client's lease explicitly
 * permits only this one tool, demonstrating fine-grained capability scoping.
 */
      ...
      JobHandle handle =
          client.submit(
              ArcpClient.jobSubmit(
                  "weather-skill@1.0.0",
                  JsonNodeFactory.instance.objectNode().put("location", "San Francisco"),
                  lease,
                  null,
                  null,
                  null));
