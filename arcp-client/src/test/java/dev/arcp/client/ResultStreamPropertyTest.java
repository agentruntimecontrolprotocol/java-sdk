...
/**
 * §8.4 result-chunk reassembly property: for any partition of a byte array into chunks emitted in
 * any arrival order, the reassembled output equals the original concatenation.
 */
    ...
    for (int seq = 0; seq < n; seq++) {
      ...
      chunks.add(
          new ResultChunkEvent(
              id, seq, Base64.getEncoder().encodeToString(slice), "base64", seq < n - 1));
    }
