...
/**
 * Demonstrates OpenTelemetry tracing integration: the client transport is wrapped with {@link
 * ArcpOtel#withTracing}, causing every send/receive to emit spans captured by an {@link
...
public final class Main {
  public static void main(String[] args) throws Exception {
    ...
    ArcpRuntime runtime =
        ArcpRuntime.builder()
            .agent(
                "trace-echo", "1.0.0", (input, ctx) -> JobOutcome.Success.inline(input.payload()))
            .build();
      ...
      JobHandle handle =
          client.submit(
              ArcpClient.jobSubmit(
                  "trace-echo@1.0.0", JsonNodeFactory.instance.objectNode().put("msg", "hello")));
    ...
    assert !exporter.getFinishedSpanItems().isEmpty() : "expected at least one span to be recorded";
