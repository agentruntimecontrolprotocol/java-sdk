...
/**
 * Jakarta WebSocket endpoint that hands every accepted session to the runtime via a freshly-built
 * {@link WebSocketJsonTransport}.
 */
public final class ArcpJettyEndpoint extends Endpoint {
  ...
  public void onOpen(Session session, EndpointConfig config) {
    ...
    WebSocketJsonTransport transport = new WebSocketJsonTransport(session, runtime.mapper());
