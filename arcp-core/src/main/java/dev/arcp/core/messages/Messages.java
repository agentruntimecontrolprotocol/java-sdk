...
/**
 * Encode/decode helpers binding a polymorphic {@link Message} to the envelope's {@code payload}
 * {@link JsonNode}. The {@code type} string is the canonical discriminator on the wire.
 */
