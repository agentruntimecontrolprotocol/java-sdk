...
public final class MemoryTransport implements Transport {
  ...
  public static MemoryTransport[] pair() {
    ...
    var aPub = new SubmissionPublisher<Envelope>(Executors.newVirtualThreadPerTaskExecutor(), 1024);
    var bPub = new SubmissionPublisher<Envelope>(Executors.newVirtualThreadPerTaskExecutor(), 1024);
